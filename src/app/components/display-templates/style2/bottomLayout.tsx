...
import HeroImage from '@/assets/images/styles/style2-bottom-layout-images.webp';
...
export default function Style2BottomLayout({
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                zIndex:
                  (selectedContent === 'Announcements' &&
                    (mainContentData?.announcementData?.announcementType ===
                      'image' ||
                      mainContentData?.announcementData?.announcementType ===
                        'video')) ||
