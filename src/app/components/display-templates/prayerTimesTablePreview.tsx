...
function PrayerTimesTablePreviewSkeleton({
  colors,
  className = '',
}: {
  colors?: colorProps;
              ...
              >
                ...
                >
                  ...
                  <div
                    className="bg-gray-300 rounded"
                    style={{
                      width: `${pxToRem(SKELETON_WIDTHS[index] || 80)}`,
                      height: `${pxToRem(32)}`,
                    }}
                  />
                </div>
...
interface PrayerTimesTablePreviewProps {
...
const PrayerTimesTablePreview: React.FC<PrayerTimesTablePreviewProps> = ({
  prayerTimes,
  className = '',
  colors,
  loadingDelay = 500,
  ...
  if (isLoading) {
    return (
      <PrayerTimesTablePreviewSkeleton colors={colors} className={className} />
    );
  }
              ...
              <div
                ...
                style={{
                  backgroundColor: isActive
                    ...
                    : 'transparent',
                  padding: `${pxToRem(14)} ${pxToRem(14)}`,
                  borderRadius: isActive ? `${pxToRem(12)}` : '0',
                  borderBottom: '0',
                }}
              >
                <div
...
export default PrayerTimesTablePreview;
