...
import HeroImage from '@/assets/images/styles/style6-l-layout.png';
...
export default function Style6BottomLayout({
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <Image
            src={HeroImage}
            alt=""
            className="w-full h-full absolute inset-0 z-0 pointer-events-none object-cover"
            fill
            loading="lazy"
          />
      ...
      {/* Bottom Section - Prayer Times Bottom(Full Width) */}
      <div
        style={{
          height: `${pxToRem(188)}`,
        }}
