...
import HeroImage from '@/assets/images/styles/bg-1.png';
...
// Dynamic imports will be handled within the component

import Style1PatternBottom from '@/app/components/display-templates/Style1PatternBottom';
...
export default function Style1BottomLayout({
  ...
  return (
    <div
      ...
      style={{
        padding: `${pxtoVw(24)} ${pxtoVw(24)} ${pxtoVw(0)} `,
    ...
    >
      ...
      >
        <div
          ...
          style={{
            gridTemplateColumns: `${pxtoVw(393)} 1fr`,
            gap: `${pxtoVw(24)}`,
          }}
        >
          <MosqueNameClockDate
