...
import HeroImage from '@/assets/images/styles/bg-1-l-layout.png';
...
import Style1PatternLLayout from '../Style1PatternLLayout';
...
const AnnouncementSmallVertical = dynamic(
  () =>
    import(
      '@/app/components/display-templates/announcementSmallVerticalPreview'
    )
);
...
export default function Style1LLayout({
  ...
  const prayerTimes = [
    ...
    { name: 'Ashr', scheduledTime: '14:58 PM', iqamahTime: '15:00 PM' },
    { name: 'Maghrib', scheduledTime: '17:35 PM', iqamahTime: '17:40 PM' },
    { name: "Isya'", scheduledTime: '18:45 PM', iqamahTime: '18:50 PM' },
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Right Side - Main Content Area with Background */}
        <div
          className="flex-1 relative overflow-hidden rounded-tr-4xl rounded-br-4xl"
          style={{
            minHeight: `${pxToRem(836)}`,
          }}
        >
          {/* Background Images */}
          {colors.themeColor === null || colors.themeColor === '#FCD29A' ? (
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(259deg, ${
                      colors?.secondaryColor || '#fff'
                    } 2.01%, ${colors?.themeColor || '#FCD29A'} 50.67%, ${
                      colors?.secondaryColor || '#fff'
                    } 100%)`,
                  }}
                ></div>
                <Style1PatternLLayout
                  className="w-full h-full absolute inset-0 z-0 pointer-events-none"
                  themeColor={colors?.themeColor || '#FCD29A'}
                />
                <div
                  className="w-full h-full absolute inset-0 z-0 pointer-events-none"
                  style={{
                    background:
                      ...
                      hexToRgba(colors?.secondaryColor || '#fff', 0.5) +
                      ' 0%, ' +
          ...
          >
            ...
            <div
              className="w-full h-full absolute inset-0 z-11 pointer-events-none"
              style={{
                background:
                  'linear-gradient(to right, ' +
                  colors?.secondaryColor +
                  ' 0%, ' +
                  hexToRgba(colors?.secondaryColor || '#fff', 0.0) +
                  ' 20%)',
              }}
            ></div>
          </div>
