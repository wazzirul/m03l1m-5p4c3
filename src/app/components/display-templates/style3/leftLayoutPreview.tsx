...
import HeroImage from '@/assets/images/styles/bg-3-left.png';
...
import Style3PatternLeft from '@/app/components/display-templates/Style3PatternLeft';
...
export default function Style3LeftLayout({
      ...
      >
                ...
                <div className="w-full h-full absolute inset-0 z-0 pointer-events-none">
                  <div
                    ...
                    style={{
                      ...
                      } 2.01%, ${colors?.themeColor || '#0950A1'} 50.67%, ${
                        colors?.secondaryColor || '#1A1A1A'
                      } 100%)`,
                    }}
                  ></div>
                  <Style3PatternLeft
                    className="w-full h-full absolute inset-0 z-0 pointer-events-none"
                    themeColor={colors?.themeColor || '#0950A1'}
                  />
                  <div
                    className="w-full h-full absolute inset-0 z-0 pointer-events-none"
                    style={{
        ...
        <div
          ...
          style={{
            ...
            right: `${pxToRem(22)}`,
            padding: `${pxToRem(16)}`,
            color: hexToRgba(colors?.primaryColor || '#ffffff', 0.66),
            background: colors?.secondaryColor || '#1A1A1A',
