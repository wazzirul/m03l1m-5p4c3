...
import HeroImage from '@/assets/images/styles/bg-3-l-layout.png';
...
import Style3PatternLLayout from '@/app/components/display-templates/Style3PatternLLayout';
...
export default function Style3LLayout({
  orgName = 'MCC Diego Mosque',
              ...
              <div className="w-full h-full absolute inset-0 z-0 pointer-events-none">
                <div
                  ...
                  style={{
                    ...
                    } -65.29%, ${colors?.themeColor || '#0950A1'} 43.14%, ${
                      colors?.secondaryColor || '#1A1A1A'
                    } 153.07%)`,
                  }}
                ></div>
                <Style3PatternLLayout
                  className="w-full h-full absolute inset-0 z-0 pointer-events-none"
