...
import Illustration403 from '@/assets/images/403-illustration.png';
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-md space-y-4 text-center md:text-center mx-auto">
            ...
            <div className="pt-2 flex gap-4 items-center justify-center">
              ...
              <button
                onClick={() => router.back()}
                className="inline-block text-gray-800 underline underline-offset-4 hover:text-slate-500 font-medium transition-all duration-200 ease-out cursor-pointer"
              >
                Go back
              </button>
            </div>
